...
def test_test_fakenodo_connection(client):
    ...
    assert response.json == {
        "status": "success",
        "message": "You have successfully connected to Fakenodo",
    }
...
def test_create_deposition(client):
    ...
    assert response.json == {
        "status": "success",
        "message": "You have successfully created a deposition in Fakenodo",
    }
...
def test_delete_deposition(client):
    ...
    assert response.json == {
        "status": "success",
        "message": "You hace successfully deleted a deposition in Fakenodo",
    }
...
def test_publish_deposition(client):
    ...
    assert response.json == {
        "status": "success",
        "message": "You have successfully published a deposition in Fakenodo",
    }
